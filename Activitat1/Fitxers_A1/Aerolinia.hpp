...
// sistema de gestió de reserves de vols.
	...
	public:
	   ...
	   /* Pre: cert */
	   /* Post: Construeix una aerolinia amb el nom, el nombre mpaxim de vols i 
	   el nombre màxim de reserves rebuts per paràmetre */ 
	   Aerolinia(string nomAerolinia, int maxVols, int maxReserves);
	   ...
	   void mostrarPassatgersVol(string numVol) const;
	   ...
	   void mostrarReservesEstat(string estatReserva) const;
