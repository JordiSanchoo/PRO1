...
int main()
{
    Item* first1;
    Item* first2;
    while (readSequence(first1) and readSequence(first2)) {
        Item* result = merge(first1, first2);
        writeSequence(first1);
        makeRandomSequence(first1);
        deleteSequence(first1);
        writeSequence(first2);
        makeRandomSequence(first2);
        deleteSequence(first2);
